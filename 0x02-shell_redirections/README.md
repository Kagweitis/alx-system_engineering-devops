...
In this project, I got to learn about using the head, tail, find, wc, sort, uniq, grep, and tr commands to redirect standard input and output and combine commands in the Shell. Furthermore, I learnt about how special characters work and how to filter text from files.
